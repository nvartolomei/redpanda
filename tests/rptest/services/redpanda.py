...
class RedpandaServiceCloud(RedpandaServiceK8s):
    ...
    def set_cluster_config(self, values: dict, timeout: int = 300):
        ...
        def expect_config_matches():
            # TODO(nv): This does not work!
            #   There are additional configuration properties which are not
            #   part of the install pack.
    ...
    def _get_install_pack_cluster_config(self):
        ...
        config_profile = install_pack['config_profiles'][self.tier_name]
