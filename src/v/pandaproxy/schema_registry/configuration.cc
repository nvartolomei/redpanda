      ...
      *this,
      config::static_metadata([] {
          return config::base_property::metadata{
            ...
            .desc = "Schema Registry API listener address and port",
          };
      }),
      ...
      *this,
      config::static_metadata([] {
          return config::base_property::metadata{
            ...
            .desc = "TLS configuration for Schema Registry API.",
          };
      }),
      {},
      ...
      config::static_metadata([] {
          return config::base_property::metadata{
            ...
            = "Enable modifications to the read-only `mode` of the Schema "
              "Registry.When set to `true`, the entire Schema Registry or its "
              "subjects can be switched to `READONLY` or `READWRITE`. This "
              "property is useful for preventing unwanted changes to the "
              "entire Schema Registry or specific subjects.",
          };
      }),
      true)
      ...
      *this,
      config::static_metadata([] {
          return config::base_property::metadata{
            ...
            .desc = "Replication factor for internal `_schemas` topic. If "
                    "unset, defaults to `default_topic_replication`.",
          };
      }),
      std::nullopt)
  , api_doc_dir(
