...
TEST(LinkerTest, CancelPropagates) {
    ...
    context::context_frame<context::linker, spy_mixin> child{
      parent1,
      context::with<context::linker>(
...
TEST(LinkerTest, DeadlineMinimum) {
    ...
    context::context_frame<context::linker> child{
      parent1, context::with<context::linker>(context_ref{parent2})};
...
TEST(LinkerTest, SameParent) {
    ...
    context::context_frame<context::linker> child{
      parent, context::with<context::linker>(context_ref{parent})};
...
TEST(LinkerTest, ChainedLinks) {
    ...
    context::context_frame<context::linker> b{
      context::background(), context::with<context::linker>(context_ref{a})};

    context::context_frame<context::linker> c{
      context::background(), context::with<context::linker>(context_ref{b})};
