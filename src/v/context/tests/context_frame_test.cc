...
TEST(ContextFrameTest, CancelPropagationNoOverride) {
    ...
    child_frame child{context_ref{parent}};
...
TEST(ContextFrameTest, ContextRefCopyConstructor) {
    test_frame frame{context::background()};
...
TEST(ContextFrameTest, ContextRefMoveConstructor) {
    test_frame frame{context::background()};
    context_ref ref1{frame};
...
TEST(ContextFrameTest, CancelHandleMoveConstructor) {
    test_frame frame{context::background()};
    context::cancel_handle handle1 = frame.cancel_handle();
...
TEST(ContextFrameTest, WallDeadlineWithNoDeadline) {
    test_frame frame{context::background()};
    context_ref ref{frame};
